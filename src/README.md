...
```python
typing.Union[str, typing.Callable][str, Callable]
```
...
<td align="left"><code>None</code></td>
<td align="left">An optional string that is assigned as the id of this component in the iFrame DOM. Can be used for targeting CSS styles.</td>
</tr>
...
<td align="left"><code>None</code></td>
<td align="left">An optional list of strings that are assigned as the classes of this component in the iFrame DOM. Can be used for targeting CSS styles.</td>
</tr>
...
<td align="left"><code>None</code></td>
<td align="left">The height of the iFrame in valid css (i.e "10px). If None, the height will be automatically set to 100%</td>
</tr>
